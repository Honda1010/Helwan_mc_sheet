...
static u8 Decode_port(u8 loc_u8PinNumber){
	return loc_u8PinNumber / MIX_PIN_NUM ;
}
...
//GET DIRECTION OF PIN [OUTPUT , INPUT]
 ...
 ******************************************************************
 */
ERROR_STATUS DIO_vSetPinHigh(u8 loc_u8PinNumber){
 ...
 *********************************************************************
 */
ERROR_STATUS DIO_vSetPinLOW (u8 loc_u8PinNumber){
	u8 loc_u8ActualPort = Decode_port(loc_u8PinNumber);
	u8 loc_u8ActualPin  = Decode_pin(loc_u8PinNumber);
 ...
 **********************************************************
 */
ERROR_STATUS DIO_u8SetPort(u8 loc_u8PortNumber,u8 loc_u8Value){
 ...
 **********************************************************
 */
ERROR_STATUS DIO_u8SetToggle(u8 loc_u8PinNumber){
	u8 loc_u8ActualPort = Decode_port(loc_u8PinNumber);
	u8 loc_u8ActualPin  = Decode_pin(loc_u8PinNumber);
